...
class MainWindow(QMainWindow):
    ...
    def _setup_shortcuts(self):
        ...
        # Also match numpad Enter (Qt.Key.Key_Enter) for the same toggle
        self._toggle_sc_kp = QShortcut(QKeySequence("Ctrl+Shift+Enter"), self)
    ...
    def _update_configurable_shortcuts(self):
        self._toggle_sc.setKey(QKeySequence(self.settings.get("toggle_mode_shortcut", "Ctrl+Shift+Return")))
